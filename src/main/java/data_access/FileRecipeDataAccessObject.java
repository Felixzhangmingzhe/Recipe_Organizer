...
public class FileRecipeDataAccessObject implements CreateRecipeUserDataAccessInterface, ViewFavoritesDataAccessInterface,
    ...
    public void writeRecipe(Recipe recipe) throws JSONException {
    ...
    public void writeRecipes(List<Recipe> recipes) throws JSONException {
    ...
    public void addRecipe(Recipe recipe) throws JSONException {
        List<Recipe> recipes = readRecipes();
        recipes.add(recipe);
        writeRecipes(recipes);
    }

    private Recipe parseRecipe(JSONObject jsonRecipe) throws JSONException {
    ...
    private JSONObject createJsonRecipe(Recipe recipe) throws JSONException {
    ...
    public void update(int id, String title, String content, LocalDateTime date, boolean isFavorite, boolean isCooked, double calories) throws JSONException {
        // 读取所有食谱
        List<Recipe> recipes = readRecipes();
        // 创建更新后的食谱列表
    ...
    @Override
    public void save(Recipe recipe) throws JSONException {
        addRecipe(recipe);
    ...
    @Override
    public void updateRecipe(int id, String title, String content, LocalDateTime date, boolean isFavorite,boolean isCooked, double calories) throws JSONException {
    ...
    @Override
    public void updateCookedRecipe(int id, String title, String content, LocalDateTime date, boolean isFavorite,boolean isCooked, double calories) throws JSONException {
        update(id, title, content, date, isFavorite, isCooked, calories);
    }
    ...
    public void saveRecipesFromAPIByNum(int num) throws IOException {
    ...
    @Override
    public List<Recipe> getRecipesFromAPI(String title) throws IOException, JSONException {
        List<Recipe> resultRecipe = new ArrayList<>();
