...
public class FavoritesViewUseCaseFactory extends UseCaseFactory {
    public static FavoritesView create(ViewRecipeViewModel viewRecipeViewModel,
        ...
        ViewRecipeController favoritesViewRecipeController = createViewRecipeController(viewRecipeViewModel, viewManagerModel, DAO);
        BackController backController = createBackController(backViewModel, viewManagerModel, DAO);
        return new FavoritesView(favoritesViewRecipeController, viewRecipeViewModel, backController, viewFavoritesViewModel, viewManagerModel);
    }
